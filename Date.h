...
class Date
{
	...
	public:
			...
			bool operator >(Date& d);	//greater than relationship between two dates
			bool operator <(Date& d);	//less than relationship between two date			
			int operator -(Date& d);	//subtract Date objects to find number of days 
};
